...
public class T01_Jdbc_Test {
	public static void main(String[] args) {
	/*
	 	JDBC를 이용한 데이터베이스 처리 순서
	  순서 : JDBC드라이버 로딩 => 해당 DB 접속 => 질의(SQL 명령을 수행한다.)
	  	...
	  	2. 접속하기 : 접속이 성공하면 Connection객체가 생성된다.
	   	...
	   	3. 질의 : Statement객체 또는 PrepareedStatement객체를 이용하여
	   			SQL 문장을 실행한다.
	 ...
	 */
		...
		try {
			...
			// 5. ResulSet객체에 저장되어 있는 자료를 반복문과 next()메서드를 이용하여
			// 	   차례로 읽어와 처리한다.
